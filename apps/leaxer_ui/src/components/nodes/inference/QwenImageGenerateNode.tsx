...
export const QwenImageGenerateNode = memo(({ id, data, selected }: NodeProps) => {
    ...
    >
      <div className="w-full space-y-3">
        ...
        <div className="flex items-start gap-2 p-2 bg-purple-500/10 border border-purple-500/30 rounded text-xs text-purple-200">
          ...
          <span>Qwen2.5-VL image generation. Requires diffusion model, VAE, and LLM encoder.</span>
        </div>
        ...
        <div className="w-full space-y-1.5">
          ...
          <Input
            ...
            onKeyDown={(e) => e.stopPropagation()}
            placeholder="Path to Qwen2.5-VL GGUF"
            className="nodrag nowheel w-full h-8 text-xs bg-surface-1/50 border-overlay-0"
          />
        </div>
...
QwenImageGenerateNode.displayName = 'QwenImageGenerateNode';
